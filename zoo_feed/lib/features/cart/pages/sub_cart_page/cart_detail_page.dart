...
class _CartDetailPageState extends State<CartDetailPage> {
  ...
  Future<void> getCart() async {
    final url = Uri.parse('http://54.206.202.155:3000/api/cart/');
  ...
  Future<void> deleteCartItem(int cartId) async {
    final url = Uri.parse('http://54.206.202.155:3000/api/cart/delete/$cartId');
    final pref = await SharedPreferences.getInstance();
    final accessToken = pref.getString('access_token');
    Map<String, String> headers = {'access_token': accessToken!};
  ...
  Future<void> updateQty(int cartId, int qty, int isIncrease) async {
    final url = Uri.parse('http://54.206.202.155:3000/api/cart/update');
    final pref = await SharedPreferences.getInstance();
    final accessToken = pref.getString('access_token');
    Map<String, String> headers = {'access_token': accessToken!};

...
class _UserEditPageState extends State<UserEditPage> {
  ...
  void update() async {
    ...
    final url =
        'http://54.206.202.155:3000/api/users/update/${widget.users['id']}';
    final dio = Dio();
    ...
    try {
      ...
      final url2 = Uri.parse('http://54.206.202.155:3000/api/users/account');
                ...
                children: [
                  SizedBox(
                    ...
                    child: ClipRRect(
                        ...
                        child: image == null
                            ? Image.network(
                                'http://54.206.202.155:3000/${widget.users['imageUrl']}',
                                fit: BoxFit.cover,
                              )
                            : Image.file(
                                image!,
